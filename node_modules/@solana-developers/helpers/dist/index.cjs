...
__export(src_exports, {
  ...
  makeTokenMint: () => makeTokenMint
});
module.exports = __toCommonJS(src_exports);
var import_web3 = require("@solana/web3.js");
var import_bs58 = __toESM(require("bs58"), 1);
var import_spl_token = require("@solana/spl-token");
var import_spl_token_metadata = require("@solana/spl-token-metadata");
...
var makeTokenMint = async (connection, mintAuthority, name, symbol, decimals, uri, additionalMetadata = [], updateAuthority = mintAuthority.publicKey, freezeAuthority = null) => {
  const mint = import_web3.Keypair.generate();
  ...
  const addMetadataInstructions = additionalMetadata.map(
    (additionalMetadataItem) => {
      return (0, import_spl_token_metadata.createUpdateFieldInstruction)({
  ...
  const mintLength = (0, import_spl_token.getMintLen)([import_spl_token.ExtensionType.MetadataPointer]);
  const metadataLength = import_spl_token.TYPE_SIZE + import_spl_token.LENGTH_SIZE + (0, import_spl_token_metadata.pack)(metadata).length;
  const mintLamports = await connection.getMinimumBalanceForRentExemption(
    mintLength + metadataLength
  );
  const mintTransaction = new import_web3.Transaction().add(
    // Create Account
    ...
    (0, import_spl_token.createInitializeMetadataPointerInstruction)(
      mint.publicKey,
    ...
    // Initialize
    (0, import_spl_token_metadata.createInitializeInstruction)({
      programId: import_spl_token.TOKEN_2022_PROGRAM_ID,
      mint: mint.publicKey,
      metadata: mint.publicKey,
      name: metadata.name,
