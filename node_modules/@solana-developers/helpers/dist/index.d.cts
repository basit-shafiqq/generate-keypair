...
declare const makeTokenMint: (connection: Connection, mintAuthority: Keypair, name: string, symbol: string, decimals: number, uri: string, additionalMetadata?: Array<[
    string,
    string
]> | Record<string, string>, updateAuthority?: PublicKey, freezeAuthority?: PublicKey | null) => Promise<PublicKey>;

export { InitializeKeypairOptions, addKeypairToEnvFile, airdropIfRequired, confirmTransaction, createAccountsMintsAndTokenAccounts, getCustomErrorMessage, getExplorerLink, getKeypairFromEnvironment, getKeypairFromFile, getLogs, getSimulationComputeUnits, initializeKeypair, keypairToSecretKeyJSON, makeKeypairs, makeTokenMint };
